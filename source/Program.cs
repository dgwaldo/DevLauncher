...
namespace AMS.DevLauncher
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            GetUserConsoleInputForGitCommands(projLaunchConfigs);
        ...
        private static void GetUserConsoleInputForGitCommands(IEnumerable<ProjLaunchConfig> projects)
        {
            Console.WriteLine("-------------------------------------------------------------------------------");
            Console.WriteLine($"Select git branch for projects\n");
            Console.WriteLine("-------------------------------------------------------------------------------");

            var gitBranch = Console.ReadLine();

            var args = "-NoExit ; ";

            foreach (var proj in projects)
            {
                args += $"cd {proj.ProjectPath} ; git checkout {gitBranch}; git pull ; \n";
            }
